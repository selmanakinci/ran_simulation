...
parent_dir = "baseline comparison data/variable_requirement_05/rl"
...
bp2 = axes[1].boxplot(data_1_1, notch=False, patch_artist=True, manage_ticks=True, showmeans= True, meanline=True)
bp3 = axes[2].boxplot(data_2_1, notch=False, patch_artist=True, manage_ticks=True, showmeans= True, meanline=True)
# axes[0].plot([np.nan]+[750]*10+[1200]*20+[750]*10, linestyle='--', color='r',marker='')
# axes[1].plot([np.nan]+[750]*10+[1200]*20+[750]*10, linestyle='--', color='r',marker='')
# axes[2].plot([np.nan]+[750]*10+[1200]*20+[750]*10, linestyle='--', color='r',marker='')
axes[0].plot([np.nan]+[1000]*5*int(1000/t_custom_avg)+[1500]*10*int(1000/t_custom_avg)+[1000]*5*int(1000/t_custom_avg), linestyle='--', color='r',marker='')
axes[1].plot([np.nan]+[1000]*20*int(1000/t_custom_avg), linestyle='--', color='r',marker='')
axes[2].plot([np.nan]+[1000]*20*int(1000/t_custom_avg), linestyle='--', color='r',marker='')
#pyplot.legend(['RR','MCQI','PF'], title="Slice Manager")

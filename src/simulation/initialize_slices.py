...
def initialize_slices(sim_param, log_file):
    ...
    delay_thresholds = [1, 30, 3]  # ms
    rate_thresholds = [2000, 10000, 5000]  # kbps  float(slc.slice_param.P_SIZE / slc.slice_param.MEAN_IAT)

    packet_sizes = [2000, 10000, 5000]  # in bits
    mean_iats = [1, 2, 1]
